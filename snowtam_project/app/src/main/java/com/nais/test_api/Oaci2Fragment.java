...
public class Oaci2Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_oaci2,
                container, false);
        ...
        oaci_recup = test.sendData2();

        resultsTextView = view.findViewById(R.id.resultsTextView2);
        informationsAirport = view.findViewById(R.id.infosAirport2);
        detailsAirportLayout = view.findViewById(R.id.detailsView2);


        go_map = (Button)view.findViewById(R.id.BoutonMap2);
        go_map.setOnClickListener(this);

        view_snowtam = (Button)view.findViewById(R.id.snowtamButton2);
        view_details = (Button)view.findViewById(R.id.detailsButton2);

        meteo = (ImageView)view.findViewById(R.id.meteoImage2);
        flag = (ImageView)view.findViewById(R.id.flagImage2);
        row = (TableRow)view.findViewById(R.id.tableRow2_2);
