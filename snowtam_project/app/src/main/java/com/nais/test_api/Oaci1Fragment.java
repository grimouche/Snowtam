...
public class Oaci1Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_oaci1,
                container, false);
        ...
        oaci_recup = test.sendData();

        resultsTextView = view.findViewById(R.id.resultsTextView);
        informationsAirport = view.findViewById(R.id.infosAirport);
        detailsAirportLayout = view.findViewById(R.id.detailsView);


        go_map = (Button)view.findViewById(R.id.BoutonMap);
        go_map.setOnClickListener(this);

        view_snowtam = (Button)view.findViewById(R.id.snowtamButton);
        view_details = (Button)view.findViewById(R.id.detailsButton);

        meteo = (ImageView)view.findViewById(R.id.meteoImage);
        flag = (ImageView)view.findViewById(R.id.flagImage);
        row = (TableRow)view.findViewById(R.id.tableRow2_1);
