...
public class Oaci4Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_oaci4,
                container, false);
        ...
        oaci_recup = test.sendData4();

        resultsTextView = view.findViewById(R.id.resultsTextView4);
        informationsAirport = view.findViewById(R.id.infosAirport4);
        detailsAirportLayout = view.findViewById(R.id.detailsView4);


        go_map = (Button)view.findViewById(R.id.BoutonMap4);
        go_map.setOnClickListener(this);

        view_snowtam = (Button)view.findViewById(R.id.snowtamButton4);
        view_details = (Button)view.findViewById(R.id.detailsButton4);

        meteo = (ImageView)view.findViewById(R.id.meteoImage4);
        flag = (ImageView)view.findViewById(R.id.flagImage4);
        row = (TableRow)view.findViewById(R.id.tableRow2_4);
